...
//   @ReactMethod
//   public void PrepareRecording(String recordingPath, ReadableMap recordingSettings, Promise promise) {
//     if (isRecording){
...
//     if (recorder == null){
//       logAndRejectPromise(promise, "RECORDING_NOT_PREPARED", "Please call PrepareRecording before starting recording");
//       return;
//     }
//     if (isRecording){
//       logAndRejectPromise(promise, "INVALID_STATE", "Please call stopRecording before starting recording");
